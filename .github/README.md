...
| Caplet                                                                    | Description                                                           |
| ------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| [dhcpv6-spoofing](../bettercap/caplets/dhcpv6-spoofing.cap)               | DHCPv6 spoofing against target domains.                               |
| [dns-spoofing](../bettercap/caplets/dns-spoofing.cap)                     | DNS spoofing with full wildcard resolution against target domains.    |
